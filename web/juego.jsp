        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                  ...
                  <td style="width: 87px;"><%= request.getAttribute("ganadorJugada")%></td>
                  </tr>
                  <tr>
                  ...
                  <td style="width: 87px;"><%= request.getAttribute("jugadasEmpatadas") %></td>
                  </tr>
                  <tr>
...
<!-- DivTable.com -->
                ...
                <div class="col-md-6">
                    <form method="POST" action="actionGame">
                        ...
                        <br>
                        <a href="actionGame"> Empezar de nuevo </a>
                    </form>
                </div>
            </div>
        </div> 
